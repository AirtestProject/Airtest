...
如果你需要使用GUI工具，请从`官网`_下载AirtestIDE。
...
1. 使用`connect_device`_来连接任意Android设备或者Windows窗口。

2. 使用`模拟操作`_的API来测试你的游戏或者App。

3. 千万**不要**忘记`声明断言`_来验证测试结果。 
...
更详细的说明请看`Airtest Python API 文档`_或者直接看`API代码`_。
...
试试样例``airtest/playground/test_blackjack.air``，更多用法看命令行用法。
